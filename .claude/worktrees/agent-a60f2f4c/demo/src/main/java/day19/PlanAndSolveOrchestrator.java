...
/**
 * Day 19: Plan-and-Solve Orchestrator（含错误传播处理）
 *
 * 相比 Day 17 的改进：
 * 1. 每个 SubAgent 的 Future 加上 exceptionally() 捕获异常，返回 fallback AgentMessage
 * 2. 下游 Agent 能感知上游失败内容，写出"诚实报告"
 * 3. aggregateResults() 汇总时标注哪些任务失败
 */
